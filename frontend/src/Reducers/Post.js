...
export const likeReducer=createReducer(initialState,(builder)=>{
    ...
    .addCase('deleteCommentFailure',(state,action)=>{
        state.loading=false;
        state.error=action.payload
    }).addCase('newPostRequest',(state,action)=>{
        state.loading=true;
        ...
        state.loading=false;
        state.error=action.payload
    }).addCase('updateCaptionRequest',(state,action)=>{
        state.loading=true;
        ...
        state.loading=false;
        state.error=action.payload
    }).addCase('deletePostRequest',(state,action)=>{
        state.loading=true;
        ...
        state.loading=false;
        state.error=action.payload
    }).addCase('updatePasswordRequest',(state,action)=>{
        state.loading=true;
        ...
        state.loading=false;
        state.error=action.payload
    }).addCase('deleteProfileRequest',(state,action)=>{
        state.loading=true;
        ...
        state.loading=false;
        state.error=action.payload
    }).addCase('followRequestRequest',(state,action)=>{
        state.loading=true;
    }).addCase('followRequestSuccess',(state,action)=>{
        state.loading=false;
        state.message=action.payload
    })
    .addCase('followRequestFailure',(state,action)=>{
        state.loading=false;
        state.error=action.payload
    })
